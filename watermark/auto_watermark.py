...
WATERMARK_MAPPING_NAMES={
    ...
    'TS': 'watermark.ts.TS',
    # Symbiotic Watermark
    'KgwExp': 'watermark.kgw_exp.KgwExp',
    'UniEXP': 'watermark.uni_exp.UniEXP',
    'UnbiasedEXP': 'watermark.unbiased_exp.UnbiasedEXP',
    'UniGumbel': 'watermark.uni_gumbel.UniGumbel',
    'KgwGumbel': 'watermark.kgw_gumbel.KgwGumbel',
}
