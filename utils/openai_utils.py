...
class OpenAIAPI:
    ...
    def __init__(self, model, temperature, system_content):
        ...
        self.client = openai.OpenAI(
            ...
            api_key="sk-1ZZ2ij3jHwwLo8zN0ESQWflomiPAXhWcRgMlRmMPwbZchshy"
        )
        ...
        if self.model not in supported_models:
            raise OpenAIModelConfigurationError(
                f"Unsupported model '{self.model}'. Supported models are {supported_models}.")
